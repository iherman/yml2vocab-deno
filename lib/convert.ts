 ...
 */
 import { RDFClass, RDFProperty, RDFIndividual, RDFPrefix, OntologyProperty, Vocab, Link, Example, global} from './common.ts';
 import { RawVocabEntry, RawVocab, ValidationResults } from './common.ts';
...
function finalizeRawEntry(raw: RawVocabEntry): RawVocabEntry {
    ...
    // The "toSeeAlso" structure needs some special treatment: be turned into an array
